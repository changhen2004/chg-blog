...
>
> 前篇：[Go Agent 设计总纲——从 ReAct 循环到 AIOps 闭环](../go-agent-design-master-plan/) | [告警链路](../go-agent-alert-chain/) | [RAG 混合检索](../go-agent-rag-retrieval/)
...
回到[设计总纲](../go-agent-design-master-plan/)中的 Agent 架构全景：
...
- [告警链路](../go-agent-alert-chain/)：告警触发 Incident，Incident 驱动 Agent 诊断
- Agent 诊断中调用 Action Tool → 进入本文的审批链
- [RAG 混合检索](../go-agent-rag-retrieval/)：Agent 诊断时通过 RAG 获取知识库证据
